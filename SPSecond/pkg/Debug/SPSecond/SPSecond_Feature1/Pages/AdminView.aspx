        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-tabs">
                    <li><a href="javascript:void(0)" class="tablinks" onclick="openView(event, 'Overview')">Overview</a></li>
                    <li><a href="javascript:void(0)" class="tablinks" onclick="openView(event, 'Volunteer')">Volunteer Detail</a></li>
                    <li><a href="javascript:void(0)" class="tablinks" onclick="openView(event, 'Batch')">Batch wise</a></li>
                </ul>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div style="height:50px">&nbsp</div>
                        <table class="table table-hover table-responsive" style="font-size:large;">
                            <thead>
                                <tr>
                                    <th>CV Type</th>
...
<div id="Batch" class="tabcontent">
  ...
  <table id="batch" class="table table-hover table-responsive" style="font-size:large;">
    ...
    <a href="javascript:void(0)" class="tablinks" onclick="openView(event, 'Overview')" id="defaultOpen" style="display:none;">Overview</a>
